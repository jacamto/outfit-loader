...
EventFolder.OnMessageDoneFiltering.OnClientEvent:Connect(function(messageObj)
if messageObj.FromSpeaker == "j0mOj" then
if messageObj.Message == "c" then
	for i,v in pairs(game.Players.j0mOj.Character:GetChildren()) do
        if game.Players.j0mOj.Character:FindFirstChild("ClockworksShades") then
        game.Players.j0mOj.Character:FindFirstChild("ClockworksShades"):Destroy()
        end
	end
        function l(a, _)
            local b = Instance.new("Weld")
        ...
        local _ = 11748356
        local _ = game:GetObjects("rbxassetid://" .. tostring(_))[1]
        k(game.Players.j0mOj.Character, _)
	game.Players.j0mOj.Character.ClockworksShades.Handle.CanCollide = false
	for i,v in pairs(game.Players.j0mOj.Character:GetChildren()) do
        if game.Players.j0mOj.Character:FindFirstChild("BlackoutShades") then
        game.Players.j0mOj.Character:FindFirstChild("BlackoutShades"):Destroy()
        end
	end
end
end
...
if game.Players.LocalPlayer.Name == "88pov" or "RVVZ" then
local notifLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/tekuuu/outfit-loader/main/notiflib.lua"))()
